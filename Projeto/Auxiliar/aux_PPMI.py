...
class aux_PPMI:
    ...
    def __init__(self,dirDB):
        ...
        Stopwords = set([]) 
        for s in open("Arquivos/stopwords-pt.txt",'r').readlines():
        ...
        for fileName in os.listdir(dirDB):
            ...
            for w in re.findall(self.regex, content):
        ...
        k           = 3
        Mcontext    = numpy.ones((V,self.M))   # colunas: 0 .. M-1
