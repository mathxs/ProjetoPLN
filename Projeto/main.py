...
teste = grafosPalavra('Arquivos/all_datasets-test_twiter.txt',1)
...
NBC1 = NBClassifier('Arquivos/all_datasets-train.txt',True)
NBC1.train()
NBC1.test_batch('Arquivos/all_datasets-test.txt')
NBC1.test_arquivo('Arquivos/all_datasets-test_twiter.txt')